...
namespace EcommerceWithPOS.Controllers
{
    public class BannersController : Controller
    {
        ...
        public BannersController(EcommerceDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Link,Image,Order,Status,CreatedAt,UpdatedAt")] Banner banner)
        {
